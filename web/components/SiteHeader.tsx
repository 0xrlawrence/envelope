  ...
  return (
    <header className="border-b border-[var(--ink-line)]">
      ...
      {/*
        ...
        */}
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-[clamp(0.5rem,1.7vh,1.15rem)] sm:px-6">
        <div className="flex items-baseline gap-2.5 sm:gap-6">
          ...
          <Link
            href="/"
            onClick={() => play("open")}
            className="group flex items-baseline gap-2.5 py-2.5 sm:py-0"
          >
          ...
          <Link
            href="/sealed"
            onClick={() => play("open")}
            className="py-3 font-display text-[0.7rem] font-semibold tracking-[0.16em] whitespace-nowrap text-[var(--paper-faint)] uppercase transition-colors duration-150 hover:text-[var(--frank)] sm:py-0 sm:text-xs sm:tracking-[0.2em]"
          >
            Sealed
          </Link>
        </div>
