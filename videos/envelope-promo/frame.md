...
typography:
  # — reading ramp —
  body:    { fontFamily: "IBM Plex Sans Condensed", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "IBM Plex Sans Condensed", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  caption: { fontFamily: "IBM Plex Sans Condensed", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  label:   { fontFamily: "IBM Plex Mono", cqw: 0.72, weight: 500, tracking: "0.14em", upper: true }
  # — display / hero ramp (IBM Plex Sans Condensed, lowercase, negative tracking) —
  h3:      { fontFamily: "IBM Plex Sans Condensed", cqw: 2.8, weight: 600, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "IBM Plex Sans Condensed", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "IBM Plex Sans Condensed", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "IBM Plex Sans Condensed", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "IBM Plex Sans Condensed", cqw: 7.5, weight: 700, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "IBM Plex Sans Condensed", cqw: 7.5, weight: 700, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "IBM Plex Sans Condensed", cqw: 10.0, weight: 700, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "IBM Plex Sans Condensed", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "IBM Plex Sans Condensed", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **IBM Plex Sans Condensed** (display) / **IBM Plex Sans** (body); ignore any preset font name lingering in prose.
...
text and becomes graphic primitive.** IBM Plex Sans Condensed `display` at 13cqw puts a single lowercase word
...
**IBM Plex Sans Condensed** carries every text role from display to body — expressive range from weight (400–900)
...
- **Massive lowercase IBM Plex Sans Condensed 900**, negative-tracked, as graphic primitive (display 13cqw).
...
Two ramps. The **reading ramp** (IBM Plex Sans Condensed body 1.2cqw, mono label 0.72cqw) carries copy + chrome; the
**display ramp** (IBM Plex Sans Condensed `h2` 4.5cqw → `display` 13cqw, weight 700–900) carries every statement.
...
- **IBM Plex Sans Condensed display is lowercase, weight 700–900, negative-tracked** (−0.04em largest, −0.02em h2). **Mono chrome is uppercase, 0.1em+.** No italic, no underline, no uppercase display.
...
IBM Plex Sans Condensed `display` (13cqw) lowercase in ink, left-anchored, over a small ink rule stub + mono kicker; a
IBM Plex Sans Condensed lead line beneath in 75% ink. **Chrome** mono catalogue number top-left, mono meta top-right
...
**Ground** ink-black. **Composes** kicker, display. **Focal** a 2–4 word IBM Plex Sans Condensed `display`/`h1`
...
row of three top-border-only stat-cards — big IBM Plex Sans Condensed-900 numeral in `{colors.fire-orange}`, IBM Plex Sans Condensed
...
**Ground** ink-black. **Composes** fadelist (3 stacked IBM Plex Sans Condensed-900 words at 1.0/0.5/0.22), fadelist-title.
...
IBM Plex Sans Condensed `quote-text` (700, lowercase) at ≤78cqw under an oversized fire-orange `quote-mark` (10cqw,
...
- Set every IBM Plex Sans Condensed display in **lowercase weight 900**, negative-tracked — the system's signature.
...
- Never uppercase IBM Plex Sans Condensed display; never add a second accent color.
...
- No serif companion; chrome is never IBM Plex Sans Condensed.
...
- **Type** — IBM Plex Sans Condensed lowercase 900 negative-tracked, fit-to-measure; mono chrome uppercase 0.14em; ≥1.4cqw floor.
...
- **IBM Plex Sans Condensed + IBM Plex Mono via Google Fonts**; Noto Sans SC is the CJK fallback (the lowercase-display signal has no CJK equivalent — the two-register color system carries the identity, per the source).
